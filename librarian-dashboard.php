...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dropdown-content a { display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: white; text-decoration: none; }
...
<body>
    ...
    <div class="container">
        <div class="welcome-section"><h1>Welcome, <?php echo htmlspecialchars($name); ?>! 👩‍💼</h1><p>Manage your library efficiently</p></div>

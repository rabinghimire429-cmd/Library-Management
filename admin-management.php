...
// =============================================
// FUNCTIONALITY: DELETE - Using Prepared Statement
// =============================================
...
// =============================================
// FUNCTIONALITY: TOGGLE STATUS - Using Prepared Statement
// =============================================
if(isset($_GET['toggle'])) {
    $toggle_id = filter_var($_GET['toggle'], FILTER_VALIDATE_INT);
    if($toggle_id) {
        $stmt = $conn->prepare("UPDATE admin SET Is_active = NOT Is_active WHERE User_id = ?");
...
// =============================================
// FUNCTIONALITY: FIND (SEARCH) & FILTER - Using Prepared Statement
// =============================================
$search = $_GET['search'] ?? '';
...
if($filter_status !== '' && $filter_status !== 'all') {
    $query .= " AND Is_active = ?";
    $status_value = ($filter_status == 'active') ? 1 : 0;
    $params[] = $status_value;
    $types .= "i";
}
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-add { background: #10b981; color: white; padding: 10px 20px; border: none; border-radius: 8px; cursor: pointer; text-decoration: none; display: inline-block; }
        ...
        .btn-edit { background: #764ba2; color: white; padding: 5px 12px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; font-size: 12px; display: inline-block; }
        .btn-delete { background: #dc2626; color: white; padding: 5px 12px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; font-size: 12px; display: inline-block; }
        .btn-toggle { background: #f59e0b; color: white; padding: 5px 12px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; font-size: 12px; display: inline-block; }
            ...
            <?php if(isset($_GET['error'])): ?>
                <div class="error-msg">
                    ...
                    switch($_GET['error']) {
                        ...
                        case 'password_short': echo "❌ Password must be at least 4 characters!"; break;
                        case 'db_error': echo "❌ Database error occurred!"; break;
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn-edit" onclick="openEditModal(<?php echo $row['User_id']; ?>, '<?php echo htmlspecialchars($row['Email']); ?>', '<?php echo $row['Role']; ?>')">Edit</button>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="admin-process.php" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <div class="error-msg" id="add_email_error" style="display:none;">Valid email required</div>
                </div>
                <div class="form-group">
                    <label>Password *</label>
                    <input type="password" id="add_password" name="password" required>
                    <div class="error-msg" id="add_password_error" style="display:none;">Password must be at least 4 characters</div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="admin-process.php">
                ...
                <div class="form-group">
                    ...
                    <small style="color: #666;">Minimum 4 characters if changing</small>
                </div>

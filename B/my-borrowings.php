...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', sans-serif; background: #0a0a2a; color: white; }
        .container { max-width: 1000px; margin: 40px auto; padding: 20px; }
        a { color: #818cf8; text-decoration: none; }
        table { width: 100%; background: rgba(255,255,255,0.05); border-radius: 16px; overflow: hidden; }
        th, td { padding: 12px; text-align: left; border-bottom: 1px solid rgba(255,255,255,0.1); }
        th { background: rgba(99,102,241,0.3); }
...
<body>
    <div class="container">
        ...
        <h2>📋 My Borrowings</h2>
        <table>
            <thead><tr><th>Book</th><th>Borrow Date</th><th>Due Date</th><th>Return Date</th><th>Fine</th><th>Status</th><th>Action</th></tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $t['return_date'] ?? 'Not returned'; ?></td>
                    <td>$<?php echo number_format($t['fine_amount'], 2); ?></td>
                    <td><?php echo $t['status']; ?></td>
                    <td><?php if(!$t['return_date']): ?><a href="?return=<?php echo $t['transaction_id']; ?>" class="btn-return" onclick="return confirm('Return this book?')">Return</a><?php else: ?>Returned<?php endif; ?></td>
                </tr>
                <?php endwhile; ?>
            </tbody>
        </table>

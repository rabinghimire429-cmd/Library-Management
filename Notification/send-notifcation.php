...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $custom_subject = $_POST['custom_subject'] ?? null;
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container { max-width: 700px; margin: 0 auto; background: rgba(255,255,255,0.1); border-radius: 30px; padding: 40px; }
        ...
        .template-preview { background: rgba(99,102,241,0.1); padding: 15px; border-radius: 12px; margin: 15px 0; font-size: 13px; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <form method="POST">
            ...
            <select name="member_id" required>
                ...
                <?php foreach($members as $m): ?>
                    <option value="<?php echo $m['member_id']; ?>"><?php echo htmlspecialchars($m['full_name'] ?: $m['email']); ?></option>
                <?php endforeach; ?>
            </select>

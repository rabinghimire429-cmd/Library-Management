<?php
// Notification/edit-notification.php
session_start();
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    $result = $notificationManager->editNotification($id, trim($_POST['message']), $_POST['notification_type']);
    if($result['success']) {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .container { max-width: 550px; margin: 0 auto; background: rgba(255,255,255,0.1); border-radius: 30px; padding: 40px; }
        ...
        .info { background: rgba(99,102,241,0.1); padding: 10px; border-radius: 12px; margin-bottom: 20px; font-size: 13px; text-align: center; }
    </style>
</head>
<body>
    <div class="container">
        <h1>✏️ Edit Notification</h1>
        <div class="info">Editing for Member ID: <?php echo $notification['member_id']; ?></div>
        ...
        <div style="text-align: center; margin-top: 20px;"><a href="notifications.php" style="color: #818cf8;">← Back</a></div>
    </div>
</body>
</html>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) { 
            ...
            .features-section, .about-section, .contact-section { padding: 60px 20px; } 
...
<body>
    ...
    <section id="home" class="hero">
        <div class="hero-content">
            ...
            <div class="cta-buttons">
                <button class="btn-primary" onclick="openLoginModal()"><i class="fas fa-sign-in-alt"></i> Login Now</button>
    ...
    <section id="about" class="about-section">
        <div class="about-content">
            <h2>About <span class="hero-gradient">LibTech Solutions</span></h2>
            <p>LibTech Solutions is a comprehensive web-based library management system designed to streamline library operations. Our system allows librarians to manage books, members, and borrowing activities efficiently while providing members with an easy way to search, borrow, and return books online.</p>
            <p>The system automatically calculates fines at $0.50 per day for overdue returns and sends email notifications for borrow confirmations, return receipts, and overdue reminders.</p>
            <div class="team-badge">
                <span><i class="fas fa-user-graduate"></i> Student Project</span>
                <span><i class="fas fa-users"></i> Team of 5 Developers</span>
                <span><i class="fas fa-code"></i> Built with PHP & MySQL</span>
            </div>
        </div>
        <div class="about-stats">
            <div class="stat-box"><div class="stat-number">500+</div><div>Books Managed</div></div>
            <div class="stat-box"><div class="stat-number">100+</div><div>Active Members</div></div>
            <div class="stat-box"><div class="stat-number">24/7</div><div>Online Access</div></div>
            <div class="stat-box"><div class="stat-number">$0.50</div><div>Daily Fine Rate</div></div>
        </div>
    </section>
    ...
    <section id="contact" class="contact-section">
        <div class="contact-container">
            <div class="contact-info">
                <h3>Get in <span class="hero-gradient">Touch</span></h3>
                <div class="contact-detail"><div class="contact-icon"><i class="fas fa-map-marker-alt"></i></div><div>Niels Brock College, Copenhagen, Denmark</div></div>
                <div class="contact-detail"><div class="contact-icon"><i class="fas fa-envelope"></i></div><div>support@libtechsolutions.com</div></div>
                <div class="contact-detail"><div class="contact-icon"><i class="fas fa-phone"></i></div><div>+45 1234 5678</div></div>
            </div>
            <div class="contact-map">
                <h4><i class="fas fa-globe"></i> Our Location</h4>
                <div class="map-placeholder">
                    <i class="fas fa-map-pin" style="font-size:30px; color:#ec4899;"></i>
                    <p style="margin-top:10px;">📍 Niels Brock College<br>Copenhagen, Denmark</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function doLibrarianLogin() {
            ...
            .then(function(data) {
                ...
                if(data.success) {
                    // Login successful - redirect to librarian dashboard
